...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	01278793          	addi	a5,a5,18 # 2040 <schedule_dm+0x27a>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	00278793          	addi	a5,a5,2 # 2040 <schedule_dm+0x27a>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	fc650513          	addi	a0,a0,-58 # 2010 <schedule_dm+0x24a>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	f8458593          	addi	a1,a1,-124 # 2018 <schedule_dm+0x252>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	f4258593          	addi	a1,a1,-190 # 2028 <schedule_dm+0x262>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	ec850513          	addi	a0,a0,-312 # 2038 <schedule_dm+0x272>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	dc458593          	addi	a1,a1,-572 # 2058 <schedule_dm+0x292>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	d5050513          	addi	a0,a0,-688 # 2060 <schedule_dm+0x29a>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	e0c50513          	addi	a0,a0,-500 # 2180 <buf.1144>
     ...
     390:	df470713          	addi	a4,a4,-524 # 2180 <buf.1144>
     ...
     3a2:	de578793          	addi	a5,a5,-539 # 2183 <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	dcd78793          	addi	a5,a5,-563 # 2183 <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	ca858593          	addi	a1,a1,-856 # 2068 <schedule_dm+0x2a2>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	da050513          	addi	a0,a0,-608 # 2180 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	d7650513          	addi	a0,a0,-650 # 2180 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	c3e58593          	addi	a1,a1,-962 # 2078 <schedule_dm+0x2b2>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	c0650513          	addi	a0,a0,-1018 # 2080 <schedule_dm+0x2ba>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	ad050513          	addi	a0,a0,-1328 # 2170 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	9d450513          	addi	a0,a0,-1580 # 2170 <whitespace>
     ...
     7be:	9be50513          	addi	a0,a0,-1602 # 2178 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	96450513          	addi	a0,a0,-1692 # 2170 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	8f850513          	addi	a0,a0,-1800 # 2170 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	77660613          	addi	a2,a2,1910 # 2088 <schedule_dm+0x2c2>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	75658593          	addi	a1,a1,1878 # 2090 <schedule_dm+0x2ca>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00001517          	auipc	a0,0x1
     950:	75450513          	addi	a0,a0,1876 # 20a0 <schedule_dm+0x2da>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	6e660613          	addi	a2,a2,1766 # 20a8 <schedule_dm+0x2e2>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	6d260613          	addi	a2,a2,1746 # 20b0 <schedule_dm+0x2ea>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	65460613          	addi	a2,a2,1620 # 20b8 <schedule_dm+0x2f2>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	5a250513          	addi	a0,a0,1442 # 20c0 <schedule_dm+0x2fa>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	50e60613          	addi	a2,a2,1294 # 20e0 <schedule_dm+0x31a>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	4da60613          	addi	a2,a2,1242 # 20e8 <schedule_dm+0x322>
    ...
    panic("parseblock");
     ...
     c2e:	4c650513          	addi	a0,a0,1222 # 20f0 <schedule_dm+0x32a>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	49e60613          	addi	a2,a2,1182 # 2100 <schedule_dm+0x33a>
    ...
    panic("syntax - missing )");
     ...
     c82:	48a50513          	addi	a0,a0,1162 # 2108 <schedule_dm+0x342>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	41060613          	addi	a2,a2,1040 # 20e8 <schedule_dm+0x322>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	32c50513          	addi	a0,a0,812 # 20a0 <schedule_dm+0x2da>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	35e50513          	addi	a0,a0,862 # 2120 <schedule_dm+0x35a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	34660613          	addi	a2,a2,838 # 2130 <schedule_dm+0x36a>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	2d678793          	addi	a5,a5,726 # 2138 <schedule_dm+0x372>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00001797          	auipc	a5,0x1
     e76:	2c678793          	addi	a5,a5,710 # 2138 <schedule_dm+0x372>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	c0868693          	addi	a3,a3,-1016 # 2158 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	b2e70713          	addi	a4,a4,-1234 # 2158 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	96678793          	addi	a5,a5,-1690 # 2150 <schedule_dm+0x38a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	86278793          	addi	a5,a5,-1950 # 21f8 <freep>
  ...
  freep = p;
    ...
    1a92:	76a78793          	addi	a5,a5,1898 # 21f8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	6e878793          	addi	a5,a5,1768 # 21f8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	6b678793          	addi	a5,a5,1718 # 21f8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	5f878793          	addi	a5,a5,1528 # 21f8 <freep>
    ...
    1c1a:	5e278793          	addi	a5,a5,1506 # 21f8 <freep>
...
0000000000001d72 <__dm_thread_cmp>:
#endif
...
static int __dm_thread_cmp(struct thread *a, struct thread *b)
{
    ...
    1d84:	47b8                	lw	a4,72(a5)
    1d86:	fe043783          	ld	a5,-32(s0)
    1d8a:	47bc                	lw	a5,72(a5)
    1d8c:	00f75463          	bge	a4,a5,1d94 <__dm_thread_cmp+0x22>
        return 1;
    1d90:	4785                	li	a5,1
    1d92:	a035                	j	1dbe <__dm_thread_cmp+0x4c>
    else if (a -> deadline > b -> deadline)
    1d94:	fe843783          	ld	a5,-24(s0)
    1d98:	47b8                	lw	a4,72(a5)
    1d9a:	fe043783          	ld	a5,-32(s0)
    1d9e:	47bc                	lw	a5,72(a5)
    1da0:	00e7d463          	bge	a5,a4,1da8 <__dm_thread_cmp+0x36>
        return 0;
    1da4:	4781                	li	a5,0
    1da6:	a821                	j	1dbe <__dm_thread_cmp+0x4c>
    else if (a -> ID < b -> ID)
    1da8:	fe843783          	ld	a5,-24(s0)
    1dac:	5fd8                	lw	a4,60(a5)
    1dae:	fe043783          	ld	a5,-32(s0)
    1db2:	5fdc                	lw	a5,60(a5)
    1db4:	00f75463          	bge	a4,a5,1dbc <__dm_thread_cmp+0x4a>
        return 1;
    1db8:	4785                	li	a5,1
    1dba:	a011                	j	1dbe <__dm_thread_cmp+0x4c>
    else 
        return 0;
    1dbc:	4781                	li	a5,0
}
    1dbe:	853e                	mv	a0,a5
    1dc0:	6462                	ld	s0,24(sp)
    1dc2:	6105                	addi	sp,sp,32
    1dc4:	8082                	ret

0000000000001dc6 <schedule_dm>:

struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    1dc6:	7171                	addi	sp,sp,-176
    1dc8:	f506                	sd	ra,168(sp)
    1dca:	f122                	sd	s0,160(sp)
    1dcc:	ed26                	sd	s1,152(sp)
    1dce:	e94a                	sd	s2,144(sp)
    1dd0:	e54e                	sd	s3,136(sp)
    1dd2:	1900                	addi	s0,sp,176
    1dd4:	84aa                	mv	s1,a0
    ...
    1dd8:	4098                	lw	a4,0(s1)
    1dda:	85ba                	mv	a1,a4
    1ddc:	853e                	mv	a0,a5
    1dde:	00000097          	auipc	ra,0x0
    1de2:	efa080e7          	jalr	-262(ra) # 1cd8 <__check_deadline_miss>
    1de6:	fca43423          	sd	a0,-56(s0)
    if (thread_dm != NULL){
    1dea:	fc843783          	ld	a5,-56(s0)
    1dee:	c395                	beqz	a5,1e12 <schedule_dm+0x4c>
        r.scheduled_thread_list_member = &thread_dm -> thread_list;
    1df0:	fc843783          	ld	a5,-56(s0)
    1df4:	02878793          	addi	a5,a5,40
    1df8:	f4f43823          	sd	a5,-176(s0)
        r.allocated_time = 0;
    1dfc:	f4042c23          	sw	zero,-168(s0)
        return r;
    1e00:	f5043783          	ld	a5,-176(s0)
    1e04:	f6f43023          	sd	a5,-160(s0)
    1e08:	f5843783          	ld	a5,-168(s0)
    1e0c:	f6f43423          	sd	a5,-152(s0)
    1e10:	aad9                	j	1fe6 <schedule_dm+0x220>
    }

    // handle the case where run queue is empty
    // TO DO
    struct thread *th = NULL;
    1e12:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list){
    1e16:	649c                	ld	a5,8(s1)
    1e18:	639c                	ld	a5,0(a5)
    1e1a:	faf43423          	sd	a5,-88(s0)
    1e1e:	fa843783          	ld	a5,-88(s0)
    1e22:	fd878793          	addi	a5,a5,-40
    1e26:	fcf43023          	sd	a5,-64(s0)
    1e2a:	a0a9                	j	1e74 <schedule_dm+0xae>
        if (thread_dm == NULL)
    1e2c:	fc843783          	ld	a5,-56(s0)
    1e30:	e791                	bnez	a5,1e3c <schedule_dm+0x76>
            thread_dm = th;
    1e32:	fc043783          	ld	a5,-64(s0)
    1e36:	fcf43423          	sd	a5,-56(s0)
    1e3a:	a015                	j	1e5e <schedule_dm+0x98>
        else if (__dm_thread_cmp(th, thread_dm) == 1)
    1e3c:	fc843583          	ld	a1,-56(s0)
    1e40:	fc043503          	ld	a0,-64(s0)
    1e44:	00000097          	auipc	ra,0x0
    1e48:	f2e080e7          	jalr	-210(ra) # 1d72 <__dm_thread_cmp>
    1e4c:	87aa                	mv	a5,a0
    1e4e:	873e                	mv	a4,a5
    1e50:	4785                	li	a5,1
    1e52:	00f71663          	bne	a4,a5,1e5e <schedule_dm+0x98>
            thread_dm = th;
    1e56:	fc043783          	ld	a5,-64(s0)
    1e5a:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list){
    1e5e:	fc043783          	ld	a5,-64(s0)
    1e62:	779c                	ld	a5,40(a5)
    1e64:	f6f43823          	sd	a5,-144(s0)
    1e68:	f7043783          	ld	a5,-144(s0)
    1e6c:	fd878793          	addi	a5,a5,-40
    1e70:	fcf43023          	sd	a5,-64(s0)
    1e74:	fc043783          	ld	a5,-64(s0)
    1e78:	02878713          	addi	a4,a5,40
    1e7c:	649c                	ld	a5,8(s1)
    1e7e:	faf717e3          	bne	a4,a5,1e2c <schedule_dm+0x66>
    }
    struct release_queue_entry *entry = NULL;
    1e82:	fa043c23          	sd	zero,-72(s0)
    if (thread_dm != NULL){
    1e86:	fc843783          	ld	a5,-56(s0)
    1e8a:	cfd5                	beqz	a5,1f46 <schedule_dm+0x180>
        int next_stop = thread_dm -> current_deadline - args.current_time;
    1e8c:	fc843783          	ld	a5,-56(s0)
    1e90:	4fb8                	lw	a4,88(a5)
    1e92:	409c                	lw	a5,0(s1)
    1e94:	40f707bb          	subw	a5,a4,a5
    1e98:	faf42a23          	sw	a5,-76(s0)
        list_for_each_entry(entry, args.release_queue, thread_list){
    1e9c:	689c                	ld	a5,16(s1)
    1e9e:	639c                	ld	a5,0(a5)
    1ea0:	f8f43423          	sd	a5,-120(s0)
    1ea4:	f8843783          	ld	a5,-120(s0)
    1ea8:	17e1                	addi	a5,a5,-8
    1eaa:	faf43c23          	sd	a5,-72(s0)
    1eae:	a8b1                	j	1f0a <schedule_dm+0x144>
            if (__dm_thread_cmp(entry -> thrd, thread_dm) == 1){
    1eb0:	fb843783          	ld	a5,-72(s0)
    1eb4:	639c                	ld	a5,0(a5)
    1eb6:	fc843583          	ld	a1,-56(s0)
    1eba:	853e                	mv	a0,a5
    1ebc:	00000097          	auipc	ra,0x0
    1ec0:	eb6080e7          	jalr	-330(ra) # 1d72 <__dm_thread_cmp>
    1ec4:	87aa                	mv	a5,a0
    1ec6:	873e                	mv	a4,a5
    1ec8:	4785                	li	a5,1
    1eca:	02f71663          	bne	a4,a5,1ef6 <schedule_dm+0x130>
    ...
    1eda:	f8f42223          	sw	a5,-124(s0)
                if (next_th < next_stop)
    1ede:	f8442703          	lw	a4,-124(s0)
    1ee2:	fb442783          	lw	a5,-76(s0)
    1ee6:	2701                	sext.w	a4,a4
    1ee8:	2781                	sext.w	a5,a5
    1eea:	00f75663          	bge	a4,a5,1ef6 <schedule_dm+0x130>
                    next_stop = next_th;
    1eee:	f8442783          	lw	a5,-124(s0)
    1ef2:	faf42a23          	sw	a5,-76(s0)
        list_for_each_entry(entry, args.release_queue, thread_list){
    1ef6:	fb843783          	ld	a5,-72(s0)
    1efa:	679c                	ld	a5,8(a5)
    1efc:	f6f43c23          	sd	a5,-136(s0)
    1f00:	f7843783          	ld	a5,-136(s0)
    1f04:	17e1                	addi	a5,a5,-8
    1f06:	faf43c23          	sd	a5,-72(s0)
    1f0a:	fb843783          	ld	a5,-72(s0)
    1f0e:	00878713          	addi	a4,a5,8
    1f12:	689c                	ld	a5,16(s1)
    1f14:	f8f71ee3          	bne	a4,a5,1eb0 <schedule_dm+0xea>
            }
        }
        r.scheduled_thread_list_member = &thread_dm -> thread_list;
    1f18:	fc843783          	ld	a5,-56(s0)
    1f1c:	02878793          	addi	a5,a5,40
    1f20:	f4f43823          	sd	a5,-176(s0)
        r.allocated_time = thread_dm -> remaining_time < next_stop? thread_dm -> remaining_time:next_stop;
    1f24:	fc843783          	ld	a5,-56(s0)
    1f28:	4bfc                	lw	a5,84(a5)
    1f2a:	863e                	mv	a2,a5
    1f2c:	fb442783          	lw	a5,-76(s0)
    1f30:	0007869b          	sext.w	a3,a5
    1f34:	0006071b          	sext.w	a4,a2
    1f38:	00d75363          	bge	a4,a3,1f3e <schedule_dm+0x178>
    1f3c:	87b2                	mv	a5,a2
    1f3e:	2781                	sext.w	a5,a5
    1f40:	f4f42c23          	sw	a5,-168(s0)
    1f44:	a849                	j	1fd6 <schedule_dm+0x210>
    }
    else {
        int next_stop = INT_MAX;
    1f46:	800007b7          	lui	a5,0x80000
    1f4a:	fff7c793          	not	a5,a5
    1f4e:	faf42823          	sw	a5,-80(s0)
        r.scheduled_thread_list_member = args.run_queue;
    1f52:	649c                	ld	a5,8(s1)
    1f54:	f4f43823          	sd	a5,-176(s0)
        list_for_each_entry(entry, args.release_queue, thread_list){
    1f58:	689c                	ld	a5,16(s1)
    1f5a:	639c                	ld	a5,0(a5)
    1f5c:	faf43023          	sd	a5,-96(s0)
    1f60:	fa043783          	ld	a5,-96(s0)
    1f64:	17e1                	addi	a5,a5,-8
    1f66:	faf43c23          	sd	a5,-72(s0)
    1f6a:	a83d                	j	1fa8 <schedule_dm+0x1e2>
            int next_th = entry -> release_time - args.current_time;
    1f6c:	fb843783          	ld	a5,-72(s0)
    1f70:	4f98                	lw	a4,24(a5)
    1f72:	409c                	lw	a5,0(s1)
    1f74:	40f707bb          	subw	a5,a4,a5
    1f78:	f8f42e23          	sw	a5,-100(s0)
            if (next_th < next_stop)
    1f7c:	f9c42703          	lw	a4,-100(s0)
    1f80:	fb042783          	lw	a5,-80(s0)
    1f84:	2701                	sext.w	a4,a4
    1f86:	2781                	sext.w	a5,a5
    1f88:	00f75663          	bge	a4,a5,1f94 <schedule_dm+0x1ce>
                next_stop = next_th;
    1f8c:	f9c42783          	lw	a5,-100(s0)
    1f90:	faf42823          	sw	a5,-80(s0)
        list_for_each_entry(entry, args.release_queue, thread_list){
    1f94:	fb843783          	ld	a5,-72(s0)
    1f98:	679c                	ld	a5,8(a5)
    1f9a:	f8f43823          	sd	a5,-112(s0)
    1f9e:	f9043783          	ld	a5,-112(s0)
    1fa2:	17e1                	addi	a5,a5,-8
    1fa4:	faf43c23          	sd	a5,-72(s0)
    1fa8:	fb843783          	ld	a5,-72(s0)
    1fac:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffd6b0>
    1fb0:	689c                	ld	a5,16(s1)
    1fb2:	faf71de3          	bne	a4,a5,1f6c <schedule_dm+0x1a6>
        }
        
        r.allocated_time = (next_stop == INT_MAX)?1:next_stop;
    1fb6:	fb042783          	lw	a5,-80(s0)
    1fba:	0007871b          	sext.w	a4,a5
    1fbe:	800007b7          	lui	a5,0x80000
    1fc2:	fff7c793          	not	a5,a5
    1fc6:	00f70563          	beq	a4,a5,1fd0 <schedule_dm+0x20a>
    1fca:	fb042783          	lw	a5,-80(s0)
    1fce:	a011                	j	1fd2 <schedule_dm+0x20c>
    1fd0:	4785                	li	a5,1
    1fd2:	f4f42c23          	sw	a5,-168(s0)
    }
    return r;
    1fd6:	f5043783          	ld	a5,-176(s0)
    1fda:	f6f43023          	sd	a5,-160(s0)
    1fde:	f5843783          	ld	a5,-168(s0)
    1fe2:	f6f43423          	sd	a5,-152(s0)
    1fe6:	4701                	li	a4,0
    1fe8:	f6043703          	ld	a4,-160(s0)
    1fec:	4781                	li	a5,0
    1fee:	f6843783          	ld	a5,-152(s0)
    1ff2:	893a                	mv	s2,a4
    1ff4:	89be                	mv	s3,a5
    1ff6:	874a                	mv	a4,s2
    1ff8:	87ce                	mv	a5,s3
    ...
    1ffa:	853a                	mv	a0,a4
    1ffc:	85be                	mv	a1,a5
    1ffe:	70aa                	ld	ra,168(sp)
    2000:	740a                	ld	s0,160(sp)
    2002:	64ea                	ld	s1,152(sp)
    2004:	694a                	ld	s2,144(sp)
    2006:	69aa                	ld	s3,136(sp)
    2008:	614d                	addi	sp,sp,176
    200a:	8082                	ret
